        ...
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          <div className="flex min-w-52">
            ...
            <div className="w-full">
              <p className="font-semibold text-primary">Total de Reservaciones</p>
            </div>
          </div>
          <div className="flex min-w-52">
            ...
            <div className="w-full">
              <p className="font-semibold text-secondary">Total de Cotizaciones</p>
            </div>
          </div>
        </div>
